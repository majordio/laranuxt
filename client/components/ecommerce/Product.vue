<template>
  <div class="">
    ...
    <div class="relative -mt-56 lg:-mt-24">
      <div class="bg-white p-6 pt-56 lg:pt-64 rounded-lg shadow-lg transition duration-500 hover:shadow-2xl">
        ...
        <h4 class="mt-1 text-xs lg:text-md leading-tight truncate">
          {{ property.title }}
        </h4>
        ...
        <div class="flex-col flex leading-3 mt-2 lg:inline-flex items-center">
          ...
          <span class="lg:ml-2 text-gray-600 text-xs lg:text-sm">{{ property.reviewCount }} reviews</span>
        </div>
      </div>
    </div>
