<template>
  <div>
    <div class="relative">
      <carousel class="absolute bg-gray-400 overflow-hidden h-full w-full object-cover rounded-lg shadow-md" :per-page="1" :loop="true" :pagination-position="'bottom-overlay'">
        <slide>
