<template>
  <div class="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <svg
      class="absolute top-0 right-0 z-10 topography-shape js-shape"
      width="1200px"
      height="580px"
      ...
      <form class="mt-8" action="#" method="POST" @submit.prevent="submit">
        ...
        <div>
          <div class="mb-3">
            ...
            >
            <div v-if="errors.email" class="text-red-400 text-xs mb-4 mt-2">
              {{ errors.email[0] }}
            </div>
          </div>
          <div>
            ...
            >
            <div v-if="errors.password" class="text-red-400 text-xs mb-4 mt-2">
              {{ errors.password[0] }}
            </div>
          </div>
        </div>
